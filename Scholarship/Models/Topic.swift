    ...
    static func projectsTopic() -> Topic {
        ...
        let whistlesParagraph: Paragraph = {
            var paragraph = Paragraph(title: "Whistles",
                                       text: NSLocalizedString("Whistles is an iPhone app that identifies birds by their songs. I developed an audio fingerprinting algorithm that consists of multiple analysis techniques including the Fast Fourier Transform and the Haar-Wavelet Transform. To store and match the generated fingerprints I have also developed a Ruby on Rails server. I won the \"Best Computer Science Graduation Project of the Year 2014\" award with it.", comment: "Crimson Text"))
    ...
    static func interestsTopic() -> Topic {
        ...
        let snowboardingParagraph: Paragraph = {
            var paragraph = Paragraph(title: NSLocalizedString("Snowboarding", comment: "Snowboarding"),
                text: NSLocalizedString("As a Swiss, I'm obsessed with the mountains. I started skiing when I was 6 years old and learnt snowboarding when I was 12. During the winter I try to go snowboarding as many times as possible. I'm still convinced that there's nothing more fun than a beautiful day with a meter of fresh powder.", comment: "Snowboarding Text"))
